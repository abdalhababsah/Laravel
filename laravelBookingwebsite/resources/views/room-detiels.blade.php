...
@section('content')
    ...
    <style>
        * {
        ...
        #hero {
            background-image: url("./images/girl-coat.jpg");
            height: 90vh;
            width: 100%;
        ...
        #sm-banner .banner-box {
            ...
            justify-content: center;
            text-align: center;
            background-image: url(images/men1.avif);
            min-width: 580px;
            height: 40vh;
            background-size: cover;
